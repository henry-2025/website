                            ...
                            setTopology(e = 1, t = 1) {
                                ...
                                (n.xSegCount = e),
                                    ...
                                    (n.attributes.uvNorm.values =
                                        new Float32Array(2 * n.vertexCount)),
                                    (n.attributes.index.values =
                                        new Uint16Array(3 * n.quadCount));
                                ...
                                for (
                                    ...
                                    for (
                                        ...
                                        const r = o + xIndex * segment_width,
                                            l =
                                                yIndex *
                                                    (geometry.xSegCount + 1) +
                                                xIndex;
                                        (geometry.attributes.position.values[
                                            3 * l +
                                                "xyz".indexOf(orientation[0])
                                        ] = r),
                                            (geometry.attributes.position.values[
                                                3 * l +
                                                    "xyz".indexOf(
...
void main() {
  ...
  float noise =
      snoise(vec3(noiseCoord.x * u_vertDeform.noiseFreq.x +
  ...
  vec3 pos = vec3(position.x, position.y + tilt + incline + noise - offset,
                  position.z);
