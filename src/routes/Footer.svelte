<footer>
    <div class="footer-container flex lg:justify-end lg:gap-x-10 mr-10">
        <p>Copyright all rights reserved Henry Pick Consulting LLC</p>
        <div class="github">
        ...
        <div class="linkedin">
            <a href="https://www.linkedin.com/in/henry-pick-b3b613183/">
                <svg
                    viewBox="0 0 24 24"
                    fill="var(--primary)"
                    width="24"
